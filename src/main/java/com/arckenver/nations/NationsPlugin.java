...
@Plugin(id = "com.arckenver.nations", name = "Nations", version = "0.1", description="A towny-like worldguard-like zone managment plugin.")
public class NationsPlugin
{
	...
	public void onInit(GameInitializationEvent event)
	{
		...
		game.getServiceManager().setProvider(this, NationsService.class, new NationsService());
	}
	...
	public void onStart(GameStartedServerEvent event)
	{
		...
		CommandSpec nationFlagCmd = CommandSpec.builder()
				...
				.arguments(
						GenericArguments.choices(Text.of("flag"),
								ConfigHandler
								.getNode("flags")
								.getNode("nations")
								.getChildrenMap()
		...
		game.getCommandManager().register(this, nationAdminCmd, "nationadmin", "na", "nationsadmin");
		game.getCommandManager().register(this, nationCmd, "nation", "n", "nations");
		game.getCommandManager().register(this, zoneCmd, "zone", "z");
		...
		game.getEventManager().registerListeners(this, new GoldenAxeListener());
		game.getEventManager().registerListeners(this, new PvpListener());
		game.getEventManager().registerListeners(this, new FireListener());
		game.getEventManager().registerListeners(this, new ExplosionListener());
		game.getEventManager().registerListeners(this, new MobSpawningListener());
		game.getEventManager().registerListeners(this, new BuildPermListener());
		game.getEventManager().registerListeners(this, new InteractPermListener());
	...
	{
		return getInstance().paginationService;
	}
