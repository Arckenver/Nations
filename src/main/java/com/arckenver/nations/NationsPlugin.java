...
@Plugin(id = "nations", name = "Nations", version = "2.1", authors={"Arckenver"}, description = "A towny-like worldguard-like zone managment plugin.", url="https://github.com/Arckenver/Nations")
