...
public class NationadminSpawnExecutor implements CommandExecutor
{
	public CommandResult execute(CommandSource src, CommandContext ctx) throws CommandException
	{
		if (src instanceof Player)
		{
			...
			{
				src.sendMessage(Text.of(TextColors.YELLOW, "/na spawn <nation> [name]"));
			...
			if (!ctx.<String>getOne("name").isPresent())
			{
				src.sendMessage(Text.builder()
						...
						.append(Utils.formatNationSpawns(nation, TextColors.YELLOW, Utils.CLICKER_ADMIN))
